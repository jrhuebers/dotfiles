...
Skips .txt files that already have content (>=1000 chars). Falls back to
pymupdf if pypdf is unavailable. Portable version: no hardcoded default dirs.
"""
import sys
import pathlib
...
def main():
    ...
    if not dirs:
        sys.exit("usage: extract_text.py [dir ...]  (no default dirs)")
